				...
				<div class="card">
					...
					<div class="card-block">
						...
						<div class="der"> 
							...
							<img src=<?= $Imagenes[7]?>  width="100" alt=<?= $Nombres[7] ?> > 
							<br>
				...
				<div class="card">
					...
					<div class="card-block">
						<div class="izq">
							...
							<img src=<?= $Imagenes[8]?> alt=<?= $Nombres[8] ?> width="80" >
							<br>
							<br>
							<p align="center"> 1</p>
						</div>
		...
		<div class="noticias">
			...
			<div class="noticia">
				<div class="card" id="card">
					<div class="card-block">
						<a href=<?= $Articulos[1] ?> style="text-decoration: none;"><h3><?=$NombresArticulos[1]?></h3></a>
					</div>
					<br>
					<a href= <?= $Articulos[1] ?> style="text-decoration: none;"><img src="<?= $ImagenesArticulos[1]?>" alt="<?= $NombresArticulos[1] ?>" width=100% ></a>
